...
## 三、跳转链
- https://baksmany.net/en
- https://baksmany.net/en/en

## 四、页面线索
- status_code：302
- content_type：text/html; charset=UTF-8
- final_url：https://baksmany.net/en/en
...
- redirect_location：/en/en
- redirect_final_url：https://baksmany.net/en/en
- title：
