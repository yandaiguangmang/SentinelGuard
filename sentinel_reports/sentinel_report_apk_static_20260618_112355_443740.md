...
## 一、检测结论
- 原始输入：`C:\Users\Lenovo\AppData\Local\Temp\tmpie6jot0s.apk`
- 对象类型：`apk`
- 状态：`ready`
- 证据条数：3 条
- 高危证据：0 条
...
- 证据：`manifest: AndroidManifest.xml; signature: META-INF/CERT.RSA; signature: META-INF/CERT.SF; signature: META-INF/MANIFEST.MF; resource: assets/appboy-html-in-app-message-javascript-component.js; resource: assets/lottie_animations/onboarding_location_permission_animation.json; resource: assets/lottie_animations/onboarding_splash_animation.json; resource: assets/omakase_waiting_for_quotes_animation.json; dex: classes.dex; dex: classes2.dex; dex: classes3.dex; resource: res/anim-v21/design_bottom_sheet_slide_in.xml`
