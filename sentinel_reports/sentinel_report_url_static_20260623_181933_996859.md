...
> 静态检测报告 · 风险等级：**CRITICAL** · 风险分数：**94/100**
> 证据分数：**94/100** · 深度研判分数：**- /100**
...
- external_intel：{'whois_registrar': 'RESERVED-Internet Assigned Numbers Authority', 'whois_country': None, 'whois_creation_date': '1995-08-14 04:00:00+00:00', 'whois_age_days': 11271}
...
- 域名注册时间：`1995-08-14 04:00:00+00:00`
- 域名注册天数：`11271` 天
...
## 七、论坛式协同研判
### 主持人（模型：`unknown`）
综合 7 条证据，当前风险等级为 critical。

### 静态分析员（模型：`unknown`）
URL 结构层面关注：域名与知名品牌高度相似、可执行文件下载、包含敏感诱导关键词、包含跳转类参数、页面包含密码输入框、可疑下载链接。

### 行为分析员（模型：`unknown`）
页面行为与跳转层面关注：页面包含密码输入框、可疑下载链接、可执行文件下载。
